 ...
 * @return array
 */
if( ! function_exists( 'blossom_shop_get_sidebar_layout_data' ) ){
    function blossom_shop_get_sidebar_layout_data(){
        return array(
...
function blossom_shop_sidebar_layout_callback(){
    global $post;
    $blossom_shop_sidebar_layout = blossom_shop_get_sidebar_layout_data();
